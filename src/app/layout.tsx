...
export const metadata: Metadata = {
	...
	openGraph: {
		title: "Rei Sikk - Web & Frontend developer",
		description:
			"I develop websites and web applications using modern tools & technologies. Based out of Tallinn, Estonia.",
		url: "https://reihopsti.ee",
	...
	twitter: {
		...
		description:
			"I develop websites and web applications using modern tools & technologies. Based out of Tallinn, Estonia.",
		images: [
			"https://opengraph.b-cdn.net/production/images/1caaaded-267f-4e0c-952a-edd016eb74de.png?token=ROqC5PZ0ksnK0Np90KbKQA9_k7Z_3-V0NvUP-cje3rs&height=732&width=1200&expires=33277000205",
		],
		creator: "@reisikk",
	},
	robots: {
